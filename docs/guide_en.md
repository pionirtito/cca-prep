<!-- Source: Paul Larionov — https://github.com/paullarionov/claude-certified-architect (guide_en.MD, verbatim copy).
     No license stated in the source repo; included here for personal study with attribution only.
     Serbian translation: docs/guide_sr.md · paired bilingual data: data/larionov.json ("Larionov" tab). -->
